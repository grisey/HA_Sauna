...
SPECS = (
    ...
    (
        "door_open_slope",
        "Experte: Öffnung Temperaturtrend",
        "°C/min",
        -1.8,
        -100,
        0,
    ...
    (
        ...
        "Experte: Öffnung Feuchteabfall oben",
        "%",
        0.45,
        0,
        100,
    ...
    (
        ...
        "Experte: Öffnung Feuchteabfall unten",
        "%",
        0.3,
        0,
        100,
    ...
    (
        "door_heating_slope",
        "Experte: Temperaturabfall trotz Heizen",
        "°C/min",
        -0.8,
        -100,
        0,
    ...
    (
        ...
        "Experte: Temperaturöffnung bestätigen",
        "s",
        5,
        1,
        600,
    ...
    (
        ...
        "Experte: Ergänzende Türerkennung unter",
        "°C",
        70,
        0,
        150,
    ...
    (
        "door_close_slope",
        "Experte: Schließung Temperaturtrend",
        "°C/min",
        0.15,
        0,
        100,
    ...
    (
        ...
        "Experte: Schließungsbestätigung",
        "s",
        3,
        1,
        600,
    ...
    (
        ...
        "Experte: Absoluter Wasserverlust beim Durchlüften",
        "%",
        30,
        0,
        100,
    ...
    (
        ...
        "Experte: Starkes Personenfenster",
        "s",
        60,
        1,
        600,
    ...
    (
        ...
        "Experte: Starker Feuchtetrend oben",
        "%/min",
        0.5,
        0,
        100,
    ...
    (
        ...
        "Experte: Starker Feuchtetrend unten",
        "%/min",
        0.5,
        0,
        100,
    ...
    (
        ...
        "Experte: Starker Temperaturtrend oben",
        "°C/min",
        0,
        -100,
        100,
    ...
    (
        ...
        "Experte: Starker Temperaturtrend unten",
        "°C/min",
        0,
        -100,
        100,
    ...
    (
        "strong_hold_seconds",
        "Experte: Starke Personenbestätigung",
        "s",
        10,
        1,
        600,
    ...
    (
        "weak_window_seconds",
        "Experte: Schwaches Personenfenster",
        "s",
        120,
        1,
        600,
    ...
    (
        "weak_humidity_upper",
        "Experte: Schwacher Feuchtetrend oben",
        "%/min",
        0.14,
        0,
        100,
    ...
    (
        "weak_humidity_lower",
        "Experte: Schwacher Feuchtetrend unten",
        "%/min",
        0.14,
        0,
        100,
    ...
    (
        ...
        "Experte: Schwacher Temperaturtrend oben",
        "°C/min",
        1,
        -100,
        100,
    ...
    (
        ...
        "Experte: Schwacher Temperaturtrend unten",
        "°C/min",
        0.8,
        -100,
        100,
    ...
    (
        "weak_hold_seconds",
        "Experte: Schwache Personenbestätigung",
        "s",
        30,
        1,
        600,
    ...
    (
        ...
        "Experte: Aufgusstemperaturänderung",
        "°C",
        -0.3,
        -100,
        100,
