...
class SaunaThermostat(SaunaEntity, ClimateEntity):
    ...
    @property
    def hvac_mode(self):
        return HVACMode.HEAT if self.runtime.session and self.runtime.session.operation_enabled else HVACMode.OFF
    ...
    def extra_state_attributes(self):
        ...
        return {"readiness_target": self.runtime.controller.readiness_target,
            "readiness_offset": values["readiness_offset_c"], "readiness_hysteresis": values["readiness_hysteresis_c"],
